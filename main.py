from tkinter import END, Button, IntVar, PhotoImage, TclError, Text, Tk, ttk
...
class vougen:
    ...
    def __init__(self, master):
        ...
        self.master = master
        master.title("MicroTic")
        master.geometry('740x530+290+100')


        # Esta línea crea el estilo temático
        style = ThemedStyle(master)
        style.set_theme("yaru")
        
        # Esta línea es para el color de fondo de los marcos
        style.configure("TLabelFrame", background="#098ab5")
        ...
        self.action_LabelFrame = ttk.LabelFrame(master, text="Acciones", height=300, width=320)
        ...
        # Widget marco de cabecera

        try:
            self.logo = PhotoImage(file="H:\Desarrollo\Python\mikrotik\microtic/mikrotik_logo.gif")
        ...
        self.labelheader = ttk.Label(self.header_LabelFrame, text="Usuario Hotspot y generador Voucher Qr")
        self.labelheader.config(font=("Arial Black", 11))
        self.labelheader.grid(row=0, column=1, sticky='e')
 

        # Widget Voucher Frame
        self.labellenpass = ttk.Label(self.voucher_LabelFrame, text=" Longitud de la contraseña :")
        ...
        self.labellenpass = ttk.Label(self.voucher_LabelFrame, text="Numero de Usuarios :")
        ...
        self.labellenpass = ttk.Label(self.voucher_LabelFrame, text="Prefijo de nombre de usuario :")
        ...
        self.labelhotnam = ttk.Label(self.voucher_LabelFrame, text="Nombre del hotspot:")
        ...
        self.labelplt = ttk.Label(self.voucher_LabelFrame, text="Tiempo límite del perfil Día(s) :")
        ...
        self.cbwtfi = ttk.Checkbutton(self.action_LabelFrame, variable=self.wtfi, \
                                      text="Guardar en un archivo", onvalue=1, offvalue=0)
        ...
        self.cbwtru = ttk.Checkbutton(self.action_LabelFrame, variable=self.wtru, \
                                      text="Escribir en el router", onvalue=1, offvalue=0, command=self.active_in)
        self.cbwtru.grid(row=1, column=0, sticky='w', padx=2, pady=2)

        self.labelrouuse = ttk.Label(self.action_LabelFrame, text="Nombre de usuario del router :")
        ...
        self.btndoit = Button(self.footer_LabelFrame, text="Generar", command=self.Btndoit)
        ...
        self.btnQuit = Button(self.footer_LabelFrame, text="Salir", command=self.BtnQuit)
    ...
    def vou_gen(self):
        ...
        pdfmetrics.registerFont(TTFont('DejaVuSans', 'H:/Desarrollo/Python/mikrotik/microtic/DejaVuSans.ttf'))
        ...
        ptemp = "H:/Desarrollo/Python/mikrotik/microtic/printtemp.jpg"
        ...
        messagebox.showinfo("Éxito", "Usuarios y vouchers generados exitosamente.")
